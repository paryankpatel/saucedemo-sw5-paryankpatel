...
public class Utility extends ManageBrowser {
     ...
     */
    public void clickOnElement(By by) {//by locator
        WebElement element = driver.findElement(by);
        element.click();
    }

    public void clickOnElement(WebElement element) {//by webelement
        element.click();
    }
...
//***************************** Is Display Methods **********************************************//
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/demo/saucedemo/screenshots/" + screenshotName + dateName + ".png";
